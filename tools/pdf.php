...
<head>
    ...
    <title>VIEWER - TOOLS</title>


    <link rel="stylesheet" href="<?= $homeurl ?>/dist/vendor/pdfjs/web/viewer.css">


    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="locale/locale.properties">
    <script src="<?= $homeurl ?>/dist/vendor/pdfjs/build/pdf.js"></script>
    <script src="<?= $homeurl ?>/dist/vendor/pdfjs/build/pdf.worker.js"></script>


    <script src="<?= $homeurl ?>/dist/vendor/pdfjs/web/viewer.js"></script>
