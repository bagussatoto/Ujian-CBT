                                    ...
                                    <div class='col-md-4'>
                                        <div class='form-group'>
                                            ...
                                            <select name="id_ujian" class='select2 form-control' style="width: 100%" required='true'>
                                                <?php $sql_mapel = mysqli_query($koneksi, "SELECT id_ujian,id_mapel,kode_nama,level,sesi FROM ujian group by id_mapel, id_ujian"); ?>
                                                <option value=''>Pilih Jadwal Ujian</option>
                                                <?php while ($mapel = mysqli_fetch_array($sql_mapel)) : ?>
                                                    <option value="<?= $mapel['id_ujian'] ?>"><?php echo strtoupper($mapel['kode_nama'] ." ". $mapel['level']." SESI ".$mapel['sesi']); ?></option>
                                                <?php endwhile ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-md-4'>
                                        <div class='form-group'>
                                            ...
                                            <select class="form-control" id="bcruang" name="ruang" required>
                                                ...
                                                <?php while ($r = mysqli_fetch_array($ruang)) : ?>
                                                    <option value="<?= $r['kode_ruang'] ?>"><?= $r['keterangan'] ?></option>
                                                <?php endwhile; ?>
                                            </select>
                                        </div>
                                    </div>
