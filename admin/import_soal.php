                    ...
                    <form id="formsoalcandy" method='post' enctype='multipart/form-data'>
                        <div class='box box-solid'>
                            ...
                            <div class='box-footer'>
                                <a href='importdatasoal.xls' <?= isset($_SESSION['is_mobile']) ? 'onclick="copyToClipboard(\''. $homeurl .'/admin/importdatasoal.xls\')"' : '' ?> ><i class='fa fa-file-excel-o'></i> Download Format</a>
                            </div>
                ...
                <div class='col-md-6'>
                    <form id="formsoalword" action='<?= $homeurl ?>/admin/pages/word_import/import/index.php/word_import' method='post' enctype='multipart/form-data'>
                        <div class='box box-solid'>
                            ...
                            <div class='box-footer'>
                                <a href='<?= $homeurl ?>/admin/pages/word_import/import/sample/sample.docx' <?= isset($_SESSION['is_mobile']) ? 'onclick="copyToClipboard(\''. $homeurl .'/admin/pages/word_import/import/sample/sample.docx\')"' : '' ?> ><i class='fa fa-file-word-o'></i> Download Format</a>
                            </div>
                        </div><!-- /.box -->
                    </form>
                </div>
