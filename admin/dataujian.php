                        ...
                        <table class='table table-bordered table-striped  table-hover'>
                            ...
                            <tbody>
                                ...
                                if ($pengawas['level'] == 'guru') {
                                    $ujianQ = mysqli_query($koneksi, "SELECT id_ujian FROM nilai a join mapel b ON a.id_mapel=b.id_mapel where b.idguru='$id_pengawas' group by id_ujian");
                                } else {
                                    $ujianQ = mysqli_query($koneksi, "SELECT id_ujian FROM nilai a join mapel b ON a.id_mapel=b.id_mapel  group by id_ujian");
                                }
