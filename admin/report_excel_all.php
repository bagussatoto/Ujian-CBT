...
<thead>
								<tr>
									...
									$mapelQ = mysqli_query($koneksi, "SELECT b.id_mapel, a.nama FROM mapel a JOIN nilai b ON a.id_mapel=b.id_mapel where b.kode_ujian='$kodeujian[id_jenis]' GROUP BY b.id_mapel ");
								...
								<tr>
									<?php
									$kode = mysqli_query($koneksi, "SELECT b.id_mapel, b.kode_ujian FROM mapel a JOIN nilai b ON a.id_mapel=b.id_mapel where b.kode_ujian='$kodeujian[id_jenis]' GROUP BY b.id_mapel");
								...
								<tr>
									<?php $mapelQ = mysqli_query($koneksi, "SELECT b.id_mapel FROM mapel a JOIN nilai b ON a.id_mapel=b.id_mapel where b.kode_ujian='$kodeujian[id_jenis]' GROUP BY b.id_mapel "); ?>
