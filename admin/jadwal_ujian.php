			...
			<div class='box-body'>
				...
				<div class="col-md-4">
					<div class="box-body">
						...
						<p>Token akan refresh setiap 15 menit (selama anda tidak meninggalkan halaman ini).
					</div>
				</div>
			</div><!-- /.box -->
		</div>
			...
			<div class="col-md-4">
				...
				<div class="box box-widget widget-user-2">
					...
					<div class="widget-user-header <?= $color  ?>" style="padding: 6px">
						<!-- /.widget-user-image -->
						<h3 style="padding: 0 5px; text-align: center; word-wrap: break-word;"><?= strtoupper($mapel['kode_nama']) ?></h3>
