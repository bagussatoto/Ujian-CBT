            ...
            <div class='box-body'>
                ...
                <?php while ($mapel = mysqli_fetch_array($mapelQ)) : ?>
                    ...
                    if ($mapel['tgl_selesai'] > date('Y-m-d H:i:s')) {
                        ...
                        $dmapel = mysqli_fetch_array(mysqli_query($koneksi, "select * from mata_pelajaran where kode_mapel='$mapel[mapel]'"));
                    ?>
                                ...
                                <div class="box box-widget widget-user-2">
                                    ...
                                    <div class="widget-user-header bg-red" style="padding: 6px">
                                        ...
                                        <span style="font-size: 20px"> <b>
                                                <?php
                                                if (strlen($dmapel['nama_mapel']) > 30) {
                                                    echo substr($dmapel['nama_mapel'], 0, 30) . "...";
                                                } else {
                                                    echo $dmapel['nama_mapel'];
                                                }
                                                ?>
